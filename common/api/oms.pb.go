...
type Order struct {
	...
	Items      []*Item `protobuf:"bytes,4,rep,name=Items,proto3" json:"Items,omitempty"` // Corrected this line
}
...
type CreateOrderRequest struct {
	...
	Items      []*ItemsWithQuantity `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"` // Corrected this line
}
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x64, 0x72, 0x65, 0x77, 0x69, 0x64, 0x69, 0x61, 0x6e, 0x74, 0x6f, 0x2f, 0x63, 0x6f,
